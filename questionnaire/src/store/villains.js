...
const quizVillains = {
    ...
    quetions: [
        ...
        // Вопрос 8
        {
            ...
            questionText: "Произошло что-то странное. Ты почувствовали, что он стал давить слабее. Повернув голову, ты увидели эти глаза. Добрые глаза. Они кричали вам о том, что всё происходящее чистой воды безумие.",
            answerOptions: [
                {
